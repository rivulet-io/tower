...
func (op *Operator) UpsertPassword(key string, password []byte, algorithm PasswordAlgorithm, saltLength int, options ...PasswordOption) error {
	...
	hashed, err := op.computePasswordHash(password, salt, algorithm, opts)
	if err != nil {
